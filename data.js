...
const CURRICULUM = [
  /* ---------- 먼저 보기 : 무엇을 만들 수 있나 ---------- */
  {
    ...
    lesson: [
      ...
      {
        h: "만든 예시 — rhwp studio: 구글 드라이브에서 한글 파일을 바로 고칩니다",
        p: "사회복지 현장은 한글(hwp·hwpx) 문서가 필수인데, 드라이브에 올린 한글 파일은 **매번 내려받아 고치고 다시 올려야** 했습니다. 강사님이 오픈 소스 rhwp를 바탕으로 **드라이브 안에서 한글 파일을 열어 고치고 바로 저장하는 앱**을 직접 만들어 워크스페이스 마켓플레이스에 올리셨습니다.\n\n· 설치: 드라이브 화면 오른쪽의 + 버튼 › 워크스페이스 마켓플레이스에서 「rhwp studio」 검색 › 설치 후 새로고침(F5)\n· 처음 열 때 한 번만 「인증하기」로 계정을 연결합니다.\n· 드라이브 설정 › 앱 관리에서 **「기본값으로 사용」**을 켜 두면 한글 파일을 더블 클릭만 해도 열립니다.\n· ⚠️ 공유받은 파일은 **편집자 권한**이어야 고칠 수 있습니다(뷰어 권한은 열람만).\n\n**현장의 불편 하나를 골라 직접 만든다** — 이 사이트가 말하는 「우리에게 맞게 직접 만든다」의 실제 모습입니다.",
      },
    ],
    videos: [
    ...
    docs: [
      { t: "rhwp studio (Google Workspace 마켓플레이스)", u: "https://workspace.google.com/marketplace/app/rhwp_studio/292079787292?hl=ko" },
      { t: "rhwp studio 소스 코드 (깃허브)", u: "https://github.com/dreamworker0/rhwp-studio" },
    ],
    notes: [],
  },
